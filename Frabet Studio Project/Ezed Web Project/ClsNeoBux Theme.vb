...
Class clsNeoBuxTheme
    ...
    Protected Overrides Sub PaintHook()
        ...
        'MenuTop
        G.FillRectangle(New SolidBrush(Color.FromArgb(255, 255, 255)), New Rectangle(1, 1, Width - 2, Height - 2))

        'Border
        G.FillRectangle(New SolidBrush(Color.Chocolate), New Rectangle(1, 35, Width - 2, Height - 38))

        'MainForm
        G.FillRectangle(New SolidBrush(Color.FromArgb(255, 255, 255)), New Rectangle(1, 36, Width - 2, Height - 39))
